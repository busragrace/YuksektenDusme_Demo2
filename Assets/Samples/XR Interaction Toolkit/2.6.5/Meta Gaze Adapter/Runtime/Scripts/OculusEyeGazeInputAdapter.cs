#if OCULUS_INTEGRATION_PRESENT || META_XR_SDK_CORE_PRESENT
#define META_EYE_GAZE_ADAPTER_AVAILABLE
#endif
...
#if OPENXR_1_6_OR_NEWER && META_EYE_GAZE_ADAPTER_AVAILABLE
...
#elif OPENXR_1_6_OR_NEWER
            Debug.LogError("Script requires Oculus Integration or Meta XR SDK Core for the OVRPlugin API. Install the SDK and add the OCULUS_INTEGRATION_PRESENT or META_XR_SDK_CORE_PRESENT scripting define symbol to enable this sample.", this);
#else
